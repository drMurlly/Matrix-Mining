...
echo ""
echo " ------------------------------------------------------------------------"
echo "After successfully installing, you must place your Wallet B signAccount.json and keystore file in the appropriate place. See screenshots for help."
echo "EXAMPLE for Miner1"
